...
const signUpSchema = z.object({
  ...
  email: z.email("Email bắt buộc phải có"),
          ...
          <form onSubmit={handleSubmit(handleOnSubmit)}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center gap-1 text-center">
                <h1 className="text-2xl font-bold">Tạo tài khoản Tasque</h1>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  ...
                  <Input id="lastName" type="text" placeholder="Nguyễn" {...register("lastName")} />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="firstName" type="text" placeholder="A" {...register("firstName")} />
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input id="email" type="email" placeholder="username123@gmail.com" {...register("email")} />
